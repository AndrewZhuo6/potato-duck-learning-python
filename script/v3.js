...
const myCSS = `
    body {
        background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../assets/images/v-preview/v3_cover.jpeg') center/cover fixed;
    }
`;
...
window.initPreparationChapter({
    chapterNumber: 3,
    chapterTitle: "Village 3: Our Inventory",
